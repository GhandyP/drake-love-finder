#!/usr/bin/env python3
"""
Drake Equation Love Finder
An entertaining application that adapts the famous Drake Equation
to estimate the probability of finding love based on various life factors.
"""
...
class LoveCalculator:
    ...
    def get_insights(self, probability: float) -> str:
        ...
        """
        if probability >= 90:
            return "Outstanding! You're extremely well-positioned for love. Keep nurturing your connections."
        elif probability >= 75:
            return "Excellent! You have great potential for finding love. Continue being your authentic self."
        elif probability >= 60:
            return "Good! There are promising chances for love. Focus on building meaningful connections."
        elif probability >= 40:
            return "Moderate! There's potential, but consider expanding your social circles or interests."
        elif probability >= 20:
            return "Low to moderate. Consider working on personal growth or exploring new activities."
        else:
            return "Very low probability. Take time to reflect on what you're looking for and how to improve your situation."
